---
title: "The Quiet Year — Solo Playthrough and Journal Part 1"
description: "A map-based post-apocalyptic storytelling game, played solo and documented week by week."
date: 2020-08-22
mediumUrl: https://medium.com/@tom.c.gray/the-quiet-year-solo-playthrough-and-journal-part-1-e1e8eb9c10c1
---

[The Quiet Year](https://buriedwithoutceremony.com/the-quiet-year) defines itself as a "map game". In it, you narrate a year in the life of a post apocalyptic community of people — the twist being, you do it entirely with cartography. Their struggles, achievements, successes, everything; whatever happens to these people, **it is represented, and ONLY represented, on a map.**

I absolutely love the idea, a while it doesn't work _perfectly_ as a solo game, I figured it would be a pretty great creative exercise to have a go at on a weekend.
...
![captionless image](https://miro.medium.com/v2/resize:fit:1400/format:webp/1*pusQhv4tmcKVxI4DF8V1sA.png)
...
![captionless image](https://miro.medium.com/v2/resize:fit:2000/format:webp/1*wLGQwGd4jfZSLHdIWWLpOw.png)
...
![captionless image](https://miro.medium.com/v2/resize:fit:2000/format:webp/1*mHpN6Czm_951LTUtApiMiA.png)
...
![captionless image](https://miro.medium.com/v2/resize:fit:2000/format:webp/1*4V9Dtqzw6MWby0JaFUw07g.png)
...
![captionless image](https://miro.medium.com/v2/resize:fit:2000/format:webp/1*q-DHF6v0h2pI7GGsf8bAhw.png)
